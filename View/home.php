<main class="main">
    ...
    <div class="container new-arrivals"><!--làm sp mới-->
        <div class="heading heading-flex mb-3">
            ...
            <div class="heading-right">
                <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="new-computers-link" data-toggle="tab" href="#new-computers-tab" role="tab" aria-controls="new-computers-tab" aria-selected="false">Computers & Laptops</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="new-acc-link" data-toggle="tab" href="#new-acc-tab" role="tab" aria-controls="new-acc-tab" aria-selected="false">Audios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="new-acc-link" data-toggle="tab" href="#new-acc-tab" role="tab" aria-controls="new-acc-tab" aria-selected="false">Digital Cameras</a>
                    </li>
                </ul>
        ...
        <div class="tab-content tab-content-carousel just-action-icons-sm">
            <div class="tab-pane p-0 fade show active" id="new-all-tab" role="tabpanel" aria-labelledby="new-all-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                    ...
                    <?php
                    $product = new product();
                    $result = $product->getAllNewProducts();
            ...
            <div class="tab-pane p-0 fade" id="new-tv-tab" role="tabpanel" aria-labelledby="new-tv-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                    ...
                    <?php
                    $product = new product();
                    $result = $product->getTVNewProducts();
                    while ($set = $result->fetch()) :
                    ?>
                        <div class="product product-2">
                            <figure class="product-media">
            ...
            <div class="tab-pane p-0 fade" id="new-computers-tab" role="tabpanel" aria-labelledby="new-computers-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                    ...
                    <?php
                    $product = new product();
                    $result = $product->getLaptopNewProducts();
                    while ($set = $result->fetch()) :
                    ?>
                        <div class="product product-2">
                            <figure class="product-media">
            ...
            <div class="tab-pane p-0 fade" id="new-phones-tab" role="tabpanel" aria-labelledby="new-phones-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                    ...
                    <?php
                    $product = new product();
                    $result = $product->getSmartphoneNewProducts();
                    while ($set = $result->fetch()) :
                    ?>
                        <div class="product product-2">
                            <figure class="product-media">
            ...
            <div class="tab-pane p-0 fade" id="new-watches-tab" role="tabpanel" aria-labelledby="new-watches-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                    ...
                    <?php
                    $product = new product();
                    $result = $product->getSmartWatchNewProducts();
                    while ($set = $result->fetch()) :
                    ?>
                        <div class="product product-2">
                            <figure class="product-media">
            ...
            <div class="tab-pane p-0 fade" id="new-acc-tab" role="tabpanel" aria-labelledby="new-acc-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                    ...
                    <?php
                    $product = new product();
                    $result = $product->getAudioNewProducts();
                    while ($set = $result->fetch()) :
                    ?>
                        <div class="product product-2">
                            <figure class="product-media">
        ...
        <div class="row">
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('assets/images/demos/demo-4/deal/bg-1.jpg');">
                    ...
                    <div class="deal-content">
                        <h3 class="product-title"><a href="index.php?action=productinfo&id=<?php echo $set['product_id'];?>&category_id=<?php echo $set['category_id'];?>">Home Smart Speaker with Google Assistant</a></h3><!-- End .product-title -->
                        ...
                        <a href="index.php?action=productinfo&id=<?php echo $set['product_id'];?>&category_id=<?php echo $set['category_id'];?>" class="btn btn-link"><span>Shop Now</span><i class="icon-long-arrow-right"></i></a>
            ...
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('assets/images/demos/demo-4/deal/bg-2.jpg');">
                    ...
                    <div class="deal-content">
                        <h3 class="product-title"><a href="index.php?action=productinfo&id=<?php echo $set['product_id'];?>&category_id=<?php echo $set['category_id'];?>">Certified Wireless Charging Pad for iPhone / Android</a></h3><!-- End .product-title -->
    ...
    <div class="bg-light pt-5 pb-6"><!-- làm sp nổi bậc, sản phẩm bán nhiều, sản phẩm sale  -->
        <div class="container trending-products">
            <div class="heading heading-flex mb-3">
                ...
                <div class="heading-right">
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="trending-top-link" data-toggle="tab" href="#trending-top-tab" role="tab" aria-controls="trending-top-tab" aria-selected="true">Top View</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content tab-content-carousel just-action-icons-sm">
                        <div class="tab-pane p-0 fade show active" id="trending-top-tab" role="tabpanel" aria-labelledby="trending-top-link">
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                ...
                                <?php
                                $product = new product();
                                $result = $product->getMostViewProducts();
                                while ($set = $result->fetch()) :
                                ?>
                                    <div class="product product-2">
                                        <figure class="product-media">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="ratings-container">
                                                <span class="ratings-text">( <?php echo $set['view_count'] ?> Views)</span></span>
                                            </div><!-- End .rating-container -->
                                        </div><!-- End .product-body -->
                                    </div><!-- End .product -->
                                <?php endwhile; ?>
                        ...
                        <div class="tab-pane p-0 fade" id="trending-best-tab" role="tabpanel" aria-labelledby="trending-best-link">
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                ...
                                <?php
                                $product = new product();
                                $result = $product->getMostSoldQuantityProducts();
                                while ($set = $result->fetch()) :
                                ?>
                                    <div class="product product-2">
                                        <figure class="product-media">
                        ...
                        <div class="tab-pane p-0 fade" id="trending-sale-tab" role="tabpanel" aria-labelledby="trending-sale-link">
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                ...
                                <?php
                                $product = new product();
                                $result = $product->getNewSaleProducts();
                                while ($set = $result->fetch()) :
                                ?>
                                    <div class="product product-2">
                                        <figure class="product-media">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="index.php?action=productinfo&id=<?php echo $set['product_id'];?>&category_id=<?php echo $set['category_id'];?>"><?php echo $set['name'] ?></a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                <strike>$ <?php echo number_format($set['price']) ?></strike> $<?php echo ($set['price'])*(($set['sale'])/100) ?>
                                            </div><!-- End .product-price -->
                                            <div class="ratings-container">
                                                <span class="ratings-text">( <?php echo $set['view_count'] ?> Views)</span></span>
                                            </div><!-- End .rating-container -->
